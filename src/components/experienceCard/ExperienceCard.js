...
export default function ExperienceCard({ cardInfo, isDark, ...props}) {
  ...
  return (
    <div className={isDark ? "experience-card-dark":"experience-card"} onClick={props.onClick}>
      ...
      <div className="experience-text-details">
        ...
        <h5 className={isDark ? "experience-text-link dark-mode-text":"experience-text-link"}>{cardInfo.link}</h5>
